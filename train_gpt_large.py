...
class Hyperparameters:
    ...
    warmup_steps: int = 10 # compile/warmup iterations before true training
...
def parse_args():
    ...
    parser.add_argument("--warmup_steps", type=int, default=None,
                        help="Number of warmup iterations before training starts")
...
if cli_args.warmup_steps is not None:
    args.warmup_steps = cli_args.warmup_steps
...
print0(f"  warmup_steps: {args.warmup_steps}")
print0("="*100)
